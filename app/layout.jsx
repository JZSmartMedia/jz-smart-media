...
export const metadata = {
  ...
  title: {
    default: 'JZ Smart Media | #1 Contractor SEO & Home Services Marketing Agency — Miami, FL',
    template: '%s | JZ Smart Media — Contractor SEO Agency Miami',
  },
  description:
    'JZ Smart Media — Miami\'s #1 contractor SEO & home services marketing agency. Expert roofing SEO, roofer SEO, HVAC SEO agency, plumber SEO, electrician marketing, solar panel marketing, kitchen & bathroom remodeling SEO, fence & flooring contractor marketing, garage door & locksmith SEO, web design for contractors, Google Ads & AI automation. Get more leads today.',
  keywords: [
  ...
  openGraph: {
    ...
    title: 'JZ Smart Media | #1 Contractor SEO & Home Services Marketing Agency — Miami, FL',
    description:
      "Miami's leading contractor SEO & home services marketing agency. Roofer SEO, HVAC SEO agency, plumber SEO, electrician marketing, solar panel marketing, kitchen & bathroom remodeling SEO, garage door & locksmith SEO, web design for contractors, Google Ads, GBP management & AI automation — built for contractors nationwide.",
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'JZ Smart Media | #1 Contractor SEO & Home Services Marketing Agency — Miami, FL',
    description:
      'Top contractor SEO agency in Miami: roofer SEO, HVAC SEO agency, plumber SEO, electrician marketing, solar panel marketing, kitchen & bathroom remodeling SEO, Google Ads, AI automation. Get more leads — call now.',
    images: ['/og-image.jpg'],
  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'JZ Smart Media provides SEO and digital marketing for a wide range of home service verticals including: roofing, plumbing, HVAC, electrical, garage door, locksmith, chimney sweep, water damage restoration, home remodeling, painting contractors, landscaping, pool service, pest control, pressure washing, concrete contractors, solar panel installation, fence contractors, flooring contractors, kitchen remodeling, bathroom remodeling, siding, insulation, and drywall contractors — as well as general contractors and construction companies nationwide.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. JZ Smart Media is headquartered in Miami, FL and serves contractors throughout South Florida including Miami, Fort Lauderdale, Boca Raton, Hialeah, Coral Gables, and Hollywood. We also serve contractors nationwide across all 50 states. Our local SEO expertise in the Miami and South Florida market gives local contractors a distinct competitive advantage.',
        },
      },
      {
        '@type': 'Question',
